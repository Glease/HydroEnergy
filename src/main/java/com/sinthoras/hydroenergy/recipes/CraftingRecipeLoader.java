...
public class CraftingRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_ModHandler.addCraftingRecipe(Hydro_ItemList.Hydro_Pump_IV.get(1L), bits, new Object[]{"SPC", "YXY", "SMC", 'S', OrePrefixes.rotor.get(Materials.TungstenSteel), 'P', ItemList.Electric_Pump_IV, 'C', OrePrefixes.cableGt01.get(Materials.Platinum), 'Y', OrePrefixes.plate.get(Materials.TungstenSteel), 'X',  ItemList.Hull_IV, 'M', ItemList.Electric_Motor_IV});
        GT_ModHandler.addCraftingRecipe(Hydro_ItemList.Hydro_Dynamo_IV.get(1L), bits, new Object[]{"CMS", "YXY", "CPS", 'S', OrePrefixes.rotor.get(Materials.TungstenSteel), 'P', ItemList.Electric_Pump_IV, 'C', OrePrefixes.cableGt01.get(Materials.Platinum), 'Y', OrePrefixes.plate.get(Materials.TungstenSteel), 'X',  ItemList.Hull_IV, 'M', ItemList.Electric_Motor_IV});
