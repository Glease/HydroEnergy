...
public class HEPacketConfigUpdate implements IMessage {
    ...
    public HEPacketConfigUpdate(int waterId, boolean debugState, boolean drainState, int limitWest, int limitDown, int limitNorth, int limitEast, int limitUp, int limitSouth) {
